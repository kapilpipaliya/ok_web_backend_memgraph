...
// clang-format off
std::tuple<ErrorCode, jsoncons::ojson> processEvent(jsoncons::ojson const &valin, Session const &session, std::string const &subDomain, ws_connector_actor_int::stateful_pointer<ok::smart_actor::connection::ws_controller_state> currentActor, bool isDispatching = false);
std::tuple<ErrorCode, jsoncons::ojson> processEvent(std::string message, Session const &session, std::string const &subDomain, ws_connector_actor_int::stateful_pointer<ok::smart_actor::connection::ws_controller_state> currentActor, bool isDispatching = false);
namespace impl
{
